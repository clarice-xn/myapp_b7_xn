package vn.edu.ueh.nghibui.myapplication_b7;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            article = (Article) intent.getSerializableExtra(EXTRA_ARTICLE);
            if (article != null) {
                article.increaseViews();
            }
        } else {
            // Xoay màn hình: lấy lại bài viết đã lưu, KHÔNG tăng views lần nữa
            article = (Article) savedInstanceState.getSerializable(STATE_ARTICLE);
        }
